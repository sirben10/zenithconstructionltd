                            ...
                            <ul id="menu-primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-has-children current-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item current-item"><a href="page-projects-full.html">PROJECTS FULL WIDTH</a></li>
                                ...
                                <div class="container-fluid maxwidth-99">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="zenith-filter style-1 text-center clearfix">
                                            ...
                                            <div class="zenith-spacer clearfix" data-desktop="40" data-mobile="35" data-smobile="35"></div>
                                            <div class="zenith-project style-1 isotope-project has-margin mg15 w25 data-effect clearfix">
                                                ...
                                                <div class="project-item green architecture building">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                ...
                                                <div class="project-item villa construction ">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                ...
                                                <div class="project-item green villa">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                            <img src="assets/img/project/project-5-440x280.jpg" alt="Image">
                                                            <div class="text-wrap text-center">                                          
                                                                <h5 class="heading"><a href="#">LAKE MEADOWS APARTMENTS</a></h5>
                                                                <div class="elm-meta">
                                                                    <span><a href="#">Architecture</a></span>
                                                ...
                                                <div class="project-item green architecture building">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                            <img src="assets/img/project/project-6-440x280.jpg" alt="Image">
                                                            <div class="text-wrap text-center">                                          
                                                                <h5 class="heading"><a href="#">LAKE MEADOWS APARTMENTS</a></h5>
                                                                <div class="elm-meta">
                                                                    <span><a href="#">Architecture</a></span>
                                                ...
                                                <div class="project-item architecture building construction">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                            <img src="assets/img/project/project-7-440x280.jpg" alt="Image">
                                                            <div class="text-wrap text-center">                                          
                                                                <h5 class="heading"><a href="#">LAKE MEADOWS APARTMENTS</a></h5>
                                                                <div class="elm-meta">
                                                                    <span><a href="#">Architecture</a></span>
                                                ...
                                                <div class="project-item villa construction ">
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                            <img src="assets/img/project/project-8-440x280.jpg" alt="Image">
                                                            <div class="text-wrap text-center">                                          
                                                                <h5 class="heading"><a href="#">LAKE MEADOWS APARTMENTS</a></h5>
                                                                <div class="elm-meta">
                                                                    <span><a href="#">Architecture</a></span>
                                            ...
                                            <div class="zenith-spacer clearfix" data-desktop="51" data-mobile="60" data-smobile="60"></div>
                                        </div><!-- /.col-md-12 -->
                                    </div><!-- /.row -->
                                </div><!-- /.container -->
                            </div>
