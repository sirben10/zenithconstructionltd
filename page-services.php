                        ...
                        <nav id="main-nav" class="main-nav">
                            <ul id="menu-primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-has-children current-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item current-item"><a href="page-services.html">SERVICES</a></li>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="zenith-carousel-box data-effect clearfix" data-gap="30" data-column="3" data-column2="2" data-column3="1" data-auto="true">
                                                <div class="owl-carousel owl-theme">
                                                    <div class="zenith-image-box style-2 clearfix">
                                            ...
                                            <div class="zenith-spacer clearfix" data-desktop="15" data-mobile="15" data-smobile="15"></div>
                                            <div class="zenith-carousel-box data-effect clearfix" data-gap="30" data-column="3" data-column2="2" data-column3="1" data-auto="true">
                                                <div class="owl-carousel owl-theme">
                                                    <div class="zenith-image-box style-2 clearfix">
                                                        <div class="image-box-item">
                                                        ...
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                ...
                                                                <div class="text-wrap">
                                                                    ...
                                                                    <p class="letter-spacing-01">zenith Construction Services provides the right resources and expertise to evaluate concepts [...]</p>
                                                                    <div class="elm-readmore">
                                                                        <a href="page-services-detail.html">DETAILS</a>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="zenith-spacer clearfix" data-desktop="45" data-mobile="60" data-smobile="60"></div>
                                        </div><!-- /.col-md-12 -->
                                    </div><!-- /.row -->
                                </div><!-- /.container -->
                            </div>
