                                                    ...
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                            <div style="height: 200px;">
                                                                <img class="img-fluid" src="projectphotos/<?php echo $result['previewPhoto']; ?>" alt="<?php echo $result['projectTitle']; ?>" height="auto">                                                                    
                                                            </div>
                                                            <div class="elm-link">
                                                        ...
                                                        <div class="text-wrap">                                                                        
                                                            <h5 class="heading"><a href="#"><?php echo htmlentities(strtoupper($result['projectTitle'])); ?></a></h5>
                                                            <div class="elm-meta">
                                                                <span><a href="#"><?php echo $result['services']; ?></a></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- /.product-item -->
